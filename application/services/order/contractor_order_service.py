...
from application.usecases.order.contractor.order_query_use_case import (
    GetCompleteOrderForContractorUseCase,
)
...
class ContractorOrderManagementServiceImpl(ContractorOrderManagementService):
    def __init__(
        self,
        create_order_use_case: CreateOrderWithDetailsUseCase,
...
class ContractorOrderQueryServiceImpl(ContractorOrderQueryService):
    def __init__(
        self, get_order_use_case: GetCompleteOrderForContractorUseCase
    ):
