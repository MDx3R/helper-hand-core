...
from domain.entities import Contractor, DetailedOrder, Order
...
class OrderRepository(ABC):
    ...
    @abstractmethod
    async def get_detailed_order_by_id_and_contractor_id(
        self, order_id: int, contractor_id: int
    ) -> DetailedOrder | None:
        """
    ...
    @abstractmethod
    async def get_detailed_open_orders_by_page(
    ...
    @abstractmethod
    async def get_detailed_open_orders_by_last_order_id(
    ...
    @abstractmethod
    async def get_contractor_orders_by_page(
    ...
    @abstractmethod
    async def get_contractor_orders_by_last_order_id(
        self, contractor_id: int, last_order_id: int = None, size: int = None
    ) -> List[Order]:
        """
    ...
    @abstractmethod
    async def get_contractor_detailed_orders_by_page(
        self, contractor_id: int, page: int = 1, size: int = None
    ) -> List[DetailedOrder]:
        """
    ...
    @abstractmethod
    async def get_contractor_detailed_orders_by_last_order_id(
        self, contractor_id: int, last_order_id: int = None, size: int = None
    ) -> List[DetailedOrder]:
        """
    ...
    @abstractmethod
    async def get_admin_orders_by_page(
    ...
    @abstractmethod
    async def get_admin_orders_by_last_order_id(
        self, admin_id: int, last_order_id: int = None, size: int = None
    ) -> List[Order]:
        """
    ...
    @abstractmethod
    async def get_contractee_orders_by_page(
    ...
    @abstractmethod
    async def get_contractee_orders_by_last_order_id(
        self, contractee_id: int, last_order_id: int = None, size: int = None
    ) -> List[Order]:
        """
    ...
    @abstractmethod
    async def get_detailed_orders_by_page(
        self, page: int = 1, size: int = None
    ) -> List[DetailedOrder]:
        """
    ...
    @abstractmethod
    async def get_closed_orders_by_page(
        self, page: int = 1, size: int = None
    ) -> List[Order]:
        """
    ...
    @abstractmethod
    async def get_active_orders_by_page(
        self, page: int = 1, size: int = None
    ) -> List[Order]:
        """
