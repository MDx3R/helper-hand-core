...
from tests.generators.mappers import (
...
def generate_test_cases():
    ...
    for result in [generator.generate_all() for generator in generators]:
        for case in result:
            test_cases.append(
                (case.mapper, case.user_base, case.role_base, case.model)
            )
    return test_cases
...
def generate_list_test_cases() -> List[
    Tuple[
        AggregatedUserMapper,
        List[Tuple[UserBase, Base]],
...
class TestToModelAggregatedUserMapper:
    @pytest.mark.parametrize(
        "mapper, user_base, role_base, expected_model", test_cases
    )
    def test_to_model_result_is_correct_instance(
        self,
        mapper: AggregatedUserMapper,
        user_base: UserBase,
        role_base,
        expected_model,
    ) -> None:
    ...
    def test_to_model_result_is_correct(
        self,
        mapper: AggregatedUserMapper,
        user_base: UserBase,
        role_base,
    ...
    def test_to_model_preserves_created_at_and_updated_at(
        self,
        mapper: AggregatedUserMapper,
        user_base: UserBase,
        role_base,
...
class TestToBaseAggregatedUserMapper:
    @pytest.mark.parametrize(
        "mapper, user_base, expected_base, model_instance", test_cases
    )
    def test_to_base_result_is_correct_instance(
        self,
        mapper: AggregatedUserMapper,
        user_base: UserBase,
        expected_base,
    ...
    def test_to_base_result_is_correct(
        self,
        mapper: AggregatedUserMapper,
        user_base: UserBase,
        expected_base,
    ...
    def test_to_base_preserves_created_at_and_updated_at(
        self,
        mapper: AggregatedUserMapper,
        user_base: UserBase,
        expected_base,
...
class TestToModelListAggregatedUserMapper:
    ...
    def test_to_model_list_result_has_same_length(
        self,
        mapper: AggregatedUserMapper,
        bases: List[Tuple[UserBase, Base]],
        expected: List[ApplicationModel],
    ) -> None:
        result: List[ApplicationModel] = mapper.to_model_list(bases)
        assert len(result) == len(expected)

    @pytest.mark.parametrize("mapper, bases, expected", list_test_cases)
    def test_to_model_list_result_is_correct_instance(
        self,
        mapper: AggregatedUserMapper,
        bases: List[Tuple[UserBase, Base]],
        expected: List[ApplicationModel],
    ...
    @pytest.mark.parametrize("mapper, bases, expected", list_test_cases)
    def test_to_model_list_result_is_correct(
        self,
        mapper: AggregatedUserMapper,
        bases: List[Tuple[UserBase, Base]],
        expected: List[ApplicationModel],
    ...
    @pytest.mark.parametrize("mapper, bases, expected", list_test_cases)
    def test_to_model_list_preserves_created_at_and_updated_at(
        self,
        mapper: AggregatedUserMapper,
        bases: List[Tuple[UserBase, Base]],
        expected: List[ApplicationModel],
    ...
    @pytest.mark.parametrize(
        "mapper",
        [
            ContracteeMapperTestCaseGenerator.mapper,
            ContractorMapperTestCaseGenerator.mapper,
            AdminMapperTestCaseGenerator.mapper,
        ],
    )
    def test_to_model_list_with_empty_list(
        self, mapper: AggregatedUserMapper
    ) -> None:
...
class TestToBaseListAggregatedUserMapper:
    ...
    def test_to_base_list_result_has_same_length(
        self,
        mapper: AggregatedUserMapper,
        expected: List[Tuple[UserBase, Base]],
    ...
    @pytest.mark.parametrize("mapper, expected, models", list_test_cases)
    def test_to_base_list_result_is_correct_instance(
        self,
        mapper: AggregatedUserMapper,
        expected: List[Tuple[UserBase, Base]],
        models: List[ApplicationModel],
        ...
        result: List[Tuple[UserBase, Base]] = mapper.to_base_list(models)
        for (user_base, role_base), (exp_user_base, exp_role_base) in zip(
            result, expected
        ):
    ...
    @pytest.mark.parametrize("mapper, expected, models", list_test_cases)
    def test_to_base_list_result_is_correct(
        self,
        mapper: AggregatedUserMapper,
        expected: List[Tuple[UserBase, Base]],
        models: List[ApplicationModel],
    ...
    @pytest.mark.parametrize("mapper, expected, models", list_test_cases)
    def test_to_base_list_preserves_created_at_and_updated_at(
        self,
        mapper: AggregatedUserMapper,
        expected: List[Tuple[UserBase, Base]],
        models: List[ApplicationModel],
    ...
    def test_to_base_list_with_empty_list(
        self, mapper: AggregatedUserMapper
    ) -> None:
